		...
		<main className="flex min-h-screen flex-col items-center justify-between p-24">
			...
			<div className="mb-32 mt-20 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
				...
				>
					...
					<p className="m-0 max-w-[30ch] text-sm opacity-50">
						Xata is a serverless data platform, built on PostgreSQL which provides a full-text and vector search engine,
						record-level file attachments, table-level aggregations and an optional ask endpoint to engage with with
